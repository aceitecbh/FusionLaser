<?php
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT $campos FROM producto WHERE producto.producto_modelo LIKE '%$busqueda%' OR producto.producto_impresora LIKE '%$busqueda%' LIKE '%$busqueda%' ORDER BY producto.producto_modelo ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(producto_id) FROM producto WHERE producto.producto_modelo LIKE '%$busqueda%' OR producto.producto_impresora LIKE '%$busqueda%' LIKE '%$busqueda%'";
		...
		foreach($datos as $rows){
			...
			$tabla.='
				<tr class="has-text-centered" >
					...
					<td>'.$categoria.'</td>
                    <td>
                        <a href="index.php?vista=modificar_producto&producto_id_up='.$rows['producto_id'].'" class="button is-link is-rounded is-small">Actualizar</a>
                    </td>
                    <td>
